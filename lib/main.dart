...
import 'package:uas_todos/widgets/header.dart';
import 'package:uas_todos/widgets/task_input.dart';
import 'package:uas_todos/widgets/todo.dart';
import 'package:uas_todos/widgets/done.dart';
import 'package:uas_todos/model/model.dart' as Model;
import 'package:uas_todos/model/db_wrapper.dart';
import 'package:uas_todos/utils/utils.dart';
import 'package:uas_todos/widgets/popup.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData.light().copyWith(
        backgroundColor: Color.fromARGB(255, 237, 238, 242),
      ),
      title: kAppTitle,
      home: HomeScreen(),
    );
